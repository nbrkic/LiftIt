      ...
      body: splitsAsync.when(
        ...
        data: (splitList) {
          if (splitList.isEmpty) {
            return const Center(child: Text('No splits yet — tap + to create one.'));
          }
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                onDismissed: (_) => ref.read(splitControllerProvider).deleteSplit(split.id),
                child: ListTile(
                  title: Text(split.name),
                  subtitle: split.description != null ? Text(split.description!) : null,
